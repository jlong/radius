if RUBY_PLATFORM == 'java'
  ...
  class JscannerTest < Test::Unit::TestCase
    include RadiusTestHelper
    
    def setup
      @context = new_context
      @parser = Radius::Parser.new(@context, :tag_prefix => 'r', :scanner => Radius::JScanner.new)
    end
    ...
    def test_parse_with_default_tag_prefix
      @parser = Radius::Parser.new(@context, :scanner => Radius::JScanner.new)
    ...
    def test_parse_with_other_radius_like_tags
      @parser = Radius::Parser.new(@context, :tag_prefix => "ralph", :scanner => Radius::JScanner.new)
    ...
    def test_copyin_global_values
      ...
      assert_equal 'bar', Radius::Parser.new(@context, :scanner => Radius::JScanner.new).context.globals.foo
    end
